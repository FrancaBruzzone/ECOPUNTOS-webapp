...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadChildren: () =>
          import('./views/graphiccompanies/routes').then((m) => m.routes),
        data: { allowedRoles: ['Company'] },
        canActivate: [AuthenticationService],
      },
      {
        ...
        loadChildren: () =>
          import('./views/graphicactivities/routes').then((m) => m.routes),
        data: { allowedRoles: ['Company'] },
        canActivate: [AuthenticationService],
      },
      {
  ...
  },
  {
    path: 'forgotpassword',
    loadComponent: () =>
      import('./views/pages/forgotpassword/forgotpassword.component').then(
